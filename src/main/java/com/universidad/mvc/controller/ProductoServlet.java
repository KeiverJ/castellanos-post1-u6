...
/**
 * Controlador MVC principal. Recibe todas las peticiones de /productos
 * y delega al servicio correspondiente según la acción solicitada.
 */
...
public class ProductoServlet extends HttpServlet {
    ...
    private void listar(HttpServletRequest req, HttpServletResponse resp)
        ...
        // Mostrar mensaje de éxito si viene de un redirect
    ...
    // Extrae los parámetros del formulario y construye un Producto
    ...
    // Método auxiliar para centralizar el forward a vistas
