...
/**
 * DAO en memoria que actúa como singleton para compartir
 * la lista de productos entre todas las peticiones.
 */
public class ProductoDAO {
    ...
    // Retorna lista no modificable para proteger la integridad de los datos
